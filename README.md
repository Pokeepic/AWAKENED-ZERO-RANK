...
The game now opens on a restrained cinematic title screen set inside Ren's apartment. Rain and individual droplets are masked to the two balcony-glass panes; impacts compress into tiny crowns and side beads along the exterior sill before fading. Desktop and mobile crop masks keep all weather away from Ren's floor, curtains, and furniture. Continue previews the current device-local save; New Game is protected; settings persist reduced motion and larger game text across routes.
