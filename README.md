...
Expand the catalog through authored dialogue, recurring characters, portals, encounters, equipment, locations, and consequences. New content should deepen character identity and world continuity rather than only multiplying random combinations. All four recurring characters now have distinct guarded and trusted voices—and matching context-aware replies from Ren—for routine, portal, injury, and guild encounters. Autonomous meetings route injury first, Gate missions to portal talk, Guild patrols and Guild meetings to Guild talk, and other overlaps to routine talk. They record the NPC line, Ren's reply, and the reaction in the same bounded dialogue history used by direct conversations. Delayed investigation consequences resolve as background effects alongside Ren's real decision, so they can change relationships and the world without consuming one of his four daily action slots.
