...
| Automated tests | 339 Python + 92 browser |
...
Version 0.510.0 begins the separate game adaptation with a small private point-and-click prologue. It authenticates the same published observer artifacts, lets the player inspect three evidence-grounded objects, and unlocks one non-binding suggestion to Ren. All interaction is local to the browser session: it does not mutate the save, advance time, or override the autonomous simulator.
