...
Version 0.260.0 completes the ability-mastery lifecycle by preventing awakened timelines from reverting mastery to zero. Version 0.261.0 authenticates fixed-event memory presence across their complete lifecycles. Version 0.262.0 brings save-event clock validation into parity with observer snapshots.
