...
| Automated tests | 339 Python + 158 browser |
...
The Gate battle now shows Ren's weapon, coat, and ward as compact illustrated loadout slots. Starter equipment and permanent upgrades use distinct pixel silhouettes, while ward readiness remains visible beside the existing deterministic consumable controls.
